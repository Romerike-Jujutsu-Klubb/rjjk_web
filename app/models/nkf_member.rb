...
class NkfMember < ApplicationRecord
  FIELD_MAP = {
    ...
    betalt_t_o_m__dato: {},
    created_at: {},
    epost: { map_to: :contact_email, map_from: :email, form_field: :frm_48_v10 },
    ...
    foresatte: { map_to: :parent_1_or_billing_name, map_from: [:billing_name, :parent_name], form_field: :frm_48_v23 },

...
class NkfSynchronizationJobTest < ActiveJob::TestCase
  ...
  test 'perform' do
    ...
    assert_match(/Oppdateringer fra NKF: #{rjjk_new_count} nye, #{rjjk_update_count} endrede/, mail.subject)
    assert_equal 'uwe@kubosch.no', mail.header[:to].value
    assert_equal 'noreply@test.jujutsu.no', mail.header[:from].value
    ...
    changes = <<~HTML.chomp # You can compare DOMS at http://prettydiff.com/
      ...
      <h2>Oppdaterte følgende eksisterende medlemmer (3)</h2>
      <ul>
        <li>Lars Erling Bråten<ul>
            <li>user:
              <ul>
                <li>first_name: &quot;Lars&quot; => &quot;Lars Erling&quot;</li><li>address: &quot;Torsvei 8b&quot; => &quot;Torsvei 8B&quot;</li><li>birthdate: Wed, 21 Jun 1967 => Sun, 24 Mar 1968</li><li>phone: nil => &quot;91735210&quot;</li>
              </ul>
            </li>
            <li>membership:
              <ul>
                    <li>phone_home: nil => &quot;67919906&quot;</li>
                    <li>phone_work: nil => &quot;63807253&quot;</li>
                    <li>joined_on: Thu, 21 Jun 2007 => Tue, 14 Oct 2003</li>
              </ul>
            </li>
          </ul>
        </li>
        <li>Sebastian Kubosch<ul>
            <li>user:
              <ul>
                <li>email: &quot;sebastian@example.com&quot; => &quot;sebastian@kubosch.no&quot;</li>
              </ul>
            </li>
            <li>membership:
                <ul>
                    <li>joined_on: Sat, 25 Aug 2007 => Tue, 21 Sep 2010</li>
                </ul>
            </li>
            <li>guardian_1: <ul><li>email: &quot;lise@example.com&quot; => &quot;lise@kubosch.no&quot;</li><li>phone: &quot;98765432&quot; => nil</li></ul></li>
            <li>guardian_2: <ul><li>phone: "5556666" => &quot;92206046&quot;</li></ul></li>
          </ul>
        </li>
        <li>Uwe Kubosch<ul>
            <li>user: <ul><li>phone: "5556666" => &quot;92206046&quot;</li><li>email: &quot;uwe@example.com&quot; => &quot;uwe@kubosch.no&quot;</li></ul></li>
            <li>membership:
              <ul><li>joined_on: Mon, 05 Jan 1987 => Fri, 15 Dec 2000</li></ul></li>
          </ul>
        </li>
      </ul>

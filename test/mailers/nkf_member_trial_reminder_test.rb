...
class NkfMemberTrialReminderTest < ActionMailer::TestCase
  def test_notify_overdue_trials
    ...
    assert_match %r{Følgende prøvemedlemmer har utløpt prøvetid:\s*<ul>\s*<li>\s*<a href="https://example.com/nkf_member_trials/113629430">Even Jensen</a> \(6 år\)\s*<ul>\s*<li>Registrert: 2010-10-02</li>\s*<li>0\s+treninger siste 2 måneder\s*</li>\s*<li>0 treninger totalt</li>\s*</ul>\s*</li>\s*</ul>}, # rubocop: disable Layout/LineLength
        mail.body

...
class CardKeysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create card_key" do
    assert_difference('CardKey.count') do
      post card_keys_url, params: { card_key: { comment: @card_key.comment, label: @card_key.label, user_id: @card_key.user_id } }
    end

    assert_redirected_to card_key_url(CardKey.last)
  end
  ...
  test "should update card_key" do
    patch card_key_url(@card_key), params: { card_key: { comment: @card_key.comment, label: @card_key.label, user_id: @card_key.user_id } }
    assert_redirected_to card_key_url(@card_key)
  end

...
class GroupTest < ActiveSupport::TestCase
  test 'suggested_graduation_date' do
    assert_equal [Date.parse('2013-12-12'), nil, Date.parse('2013-12-10'), Date.parse('2013-12-10'), nil],
  ...
  test 'suggested_graduation_date spring 2019' do
    ...
    assert_equal(
        [Date.parse('2019-06-13'), nil, Date.parse('2019-06-11'), Date.parse('2019-06-11'), nil],

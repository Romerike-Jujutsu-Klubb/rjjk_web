...
class AddMissingForeignKeys < ActiveRecord::Migration
  def self.up
    ...
    # add_foreign_key "censors", ["graduation_id"], "graduations", ["id"],
    #     :name => "censors_graduation_id_fkey"
    # add_foreign_key "censors", ["member_id"], "members", ["id"], :name => "censors_member_id_fkey"

    # add_foreign_key "graduates", ["member_id"], "members", ["id"],
    #     :name => "graduates_member_id_fkey"
    # add_foreign_key "graduates", ["graduation_id"], "graduations", ["id"],
    #     :name => "graduates_graduation_id_fkey"
    ...
    # add_foreign_key "ranks", ["martial_art_id"], "martial_arts", ["id"],
